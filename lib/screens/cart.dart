  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: appProvider.isLoading
          ? Loading()
          : ListView.builder(
              itemCount: AppConfig.cartProducts.length,
              itemBuilder: (_, index) {
                return Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ClipRRect(
                          ...
                          child: Image.network(
                            AppConfig.cartProducts[index].imageUrl,
                            height: 120,
                            width: 140,
                            fit: BoxFit.fill,
                          ),
                            ...
                            children: <Widget>[
                              RichText(
                                text: TextSpan(children: [
                                  ...
                                  TextSpan(
                                      text:
                                          "\KES${AppConfig.cartProducts[index].unitPrice} \n\n",
                                      style: TextStyle(
                                          color: black,
                                          fontSize: 18,
                              ...
                              IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    bool success =
                                        await AppConfig.removeFromCart(
                                            AppConfig.cartProducts[index].id);
                                    if (success) {
                                      ...
                                      _key.currentState.showSnackBar(SnackBar(
                                          content: Text(
                                              "Sorry, we cant seem to Remove this product from Cart!")));
                                      //appProvider.changeIsLoading();
                                    }
                                  })
                            ],
            ...
            children: <Widget>[
              RichText(
                text: TextSpan(children: [
                  ...
                  TextSpan(
                      text: "\ KES${AppConfig.totalCartPrice}",
                      style: TextStyle(
                          color: black,
                          fontSize: 22,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'You will be charged  \KES${AppConfig.totalCartPrice} upon delivery!',
                                        textAlign: TextAlign.center,
                                      ),
                                      SizedBox(
                                        width: 320.0,
                                        child: RaisedButton(
                                          onPressed: () async {
                                            ...
                                            AppConfig.createOrder(
                                              description:
                                                  "Thank you for making this order (${AppConfig.cartProductNames.toString()}).",
                                              status: "Complete",
                                              total: AppConfig.totalCartPrice,
                                            );
