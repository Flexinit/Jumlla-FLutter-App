...
class ProductSearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AppConfig.searchedProductsObjs.length < 1? Column(
        ...
        children: <Widget>[
          ...
          itemCount: AppConfig.searchedProductsObjs.length,
          itemBuilder: (context, index){
            return GestureDetector(
                onTap: ()async{
                  changeScreen(context, ProductDetails(product: AppConfig.searchedProductsObjs[index]));
                },
                child: ProductCard(product:  AppConfig.searchedProductsObjs[index]));
          }),
    );
  }
}
