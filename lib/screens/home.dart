          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              accountName: CustomText(
                ...
                text: AppConfig.username ?? "username lading...",
                color: white,
                weight: FontWeight.bold,
                size: 18,
              ),
              accountEmail: CustomText(
                text: AppConfig.username ?? "email loading...",
                color: white,
              ),
            ),
            ListTile(
                  ...
                  child: ListTile(
                    ...
                    title: TextField(
                      ...
                      onSubmitted: (pattern)async{
                        await AppConfig.getSearchedProducts(searchString: pattern);
...
//          recent products
            ...
            Column(
              children: AppConfig.productsObjs
